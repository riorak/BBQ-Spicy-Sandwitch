...
export const metadata: Metadata = {
  ...
  title: "Polyedge - Your Polymarket Companion",
  description: "The ultimate trading journal and analytics platform for Polymarket traders",
};
            ...
            <div className="flex h-screen">
              ...
              <aside className="hidden md:flex w-64 flex-col border-r border-border/40 bg-secondary/10 backdrop-blur-sm">
                ...
                <div className="px-4 py-4 border-t border-border/40 text-sm text-muted-foreground">
                  <a className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-secondary/30" href="/profile">
